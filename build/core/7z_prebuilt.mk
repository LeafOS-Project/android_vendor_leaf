...
LOCAL_SRC_FILES := $(PRODUCT_OUT)/obj/7Z_PREBUILTS/$(LOCAL_MODULE).$(TARGET_ARCH).$(LOCAL_7Z_EXT)
ifeq ($(filter /%,$(LOCAL_SRC_FILES)),)
LOCAL_SRC_FILES := $(shell echo $(LOCAL_PATH) | sed 's/[^/]*/../g')/$(LOCAL_SRC_FILES)
endif
