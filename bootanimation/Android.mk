...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	...
	@rm -rf $(dir $@)
	@mkdir -p $(dir $@)
	$(hide) tar xfp vendor/leaf/bootanimation/bootanimation.tar -C $(INTERMEDIATES)
	...
	prebuilts/tools-leaf/${HOST_OS}-x86/bin/mogrify -resize $$RESOLUTION $(INTERMEDIATES)/*/*.png; \
	echo "$$IMAGEWIDTH $$IMAGEWIDTH 60" > $(INTERMEDIATES)/desc.txt; \
	cat vendor/leaf/bootanimation/desc.txt >> $(INTERMEDIATES)/desc.txt
